...
use signature::{parse_params, parse_returns};
use syn;
...
fn codegen_foreign_module(_import_module_name: String, ast: syn::ItemForeignMod) -> TokenStream {
...
fn codegen_function_definition(mut ast: syn::ItemFn) -> TokenStream {
